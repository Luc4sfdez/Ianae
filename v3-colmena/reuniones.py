...
SALA_MAX_MENSAJES = 16       # max mensajes por conversacion
SALA_TIMEOUT_MIN = 15        # min sin respuesta = fin
SALA_CICLOS_COOLDOWN = 30    # min ciclos entre nuevas conversaciones
SALA_PROB_INICIAR = 0.05     # prob de iniciar conversacion por ciclo
SALA_PROB_RESPONDER = 0.6    # prob base de responder
SALA_MAX_POR_HERMANA = 4     # max mensajes por hermana en una conv
